...
public class MilvusVectorStore implements VectorStore {
    ...
    private List<QAPairEntity> fallbackSearch(String query, int topK) {
        List<QAPairEntity> allPairs = qaPairRepository.findAll();
        if (allPairs.isEmpty()) {
            return List.of();
        }
    ...
    private record Pair<QAPairEntity, Double>(QAPairEntity pair, Double similarity) {}
}